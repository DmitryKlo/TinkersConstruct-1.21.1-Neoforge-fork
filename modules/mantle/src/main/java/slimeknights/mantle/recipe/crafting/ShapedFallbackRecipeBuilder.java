...
public class ShapedFallbackRecipeBuilder {
  ...
  public void build(Consumer<FinishedRecipe> consumer) {
    base.save(FinishedRecipe.output(base -> consumer.accept(new Result(base, alternatives))));
  }
  ...
  public void build(Consumer<FinishedRecipe> consumer, ResourceLocation id) {
    base.save(FinishedRecipe.output(base -> consumer.accept(new Result(base, alternatives))), id);
  }
