...
public interface ICommonRecipeHelper extends IRecipeHelper {
  /** Creates the standard inventory unlock criterion for an item-like input. */
  default Criterion<?> hasItem(ItemLike item) {
    return RecipeProviderAccess.hasItem(item);
  }

  /** Creates the standard inventory unlock criterion for an item tag input. */
  default Criterion<?> hasItem(TagKey<Item> tag) {
    return RecipeProviderAccess.hasItem(tag);
  }
  ...
  default void packingRecipe(Consumer<FinishedRecipe> consumer, RecipeCategory category, String largeName, ItemLike large, String smallName, ItemLike small, String folder) {
    ...
    ShapedRecipeBuilder.shaped(category, large)
                       ...
                       .save(FinishedRecipe.output(consumer), wrap(largeId, folder, String.format("_from_%ss", smallName)));
    // block to ingot
    ...
    ShapelessRecipeBuilder.shapeless(category, small, 9)
                          ...
                          .save(FinishedRecipe.output(consumer), wrap(smallId, folder, String.format("_from_%s", largeName)));
  }
  ...
  default void slabStairsCrafting(Consumer<FinishedRecipe> consumer, BuildingBlockObject building, String folder, boolean addStonecutter) {
    ...
    Criterion<?> hasBlock = hasItem(item);
    // slab
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, slab, 6)
                       ...
                       .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_slab"));
    // stairs
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, stairs, 4)
                       ...
                       .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_stairs"));
    ...
    if (addStonecutter) {
      ...
      SingleItemRecipeBuilder.stonecutting(ingredient, RecipeCategory.BUILDING_BLOCKS, slab, 2)
                             .unlockedBy("has_item", hasBlock)
                             .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_slab_stonecutter"));
      SingleItemRecipeBuilder.stonecutting(ingredient, RecipeCategory.BUILDING_BLOCKS, stairs)
                             .unlockedBy("has_item", hasBlock)
                             .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_stairs_stonecutter"));
    }
  }
  ...
  default void stairSlabWallCrafting(Consumer<FinishedRecipe> consumer, WallBuildingBlockObject building, String folder, boolean addStonecutter) {
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, wall, 6)
                       ...
                       .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_wall"));
    // only add stonecutter if relevant
    if (addStonecutter) {
      Ingredient ingredient = Ingredient.of(item);
      SingleItemRecipeBuilder.stonecutting(ingredient, RecipeCategory.BUILDING_BLOCKS, wall)
                             .unlockedBy("has_item", hasBlock)
                             .save(FinishedRecipe.output(consumer), wrap(itemId, folder, "_wall_stonecutter"));
    }
  }
  ...
  default void woodCrafting(Consumer<FinishedRecipe> consumer, WoodBlockObject wood, String folder) {
    Criterion<?> hasPlanks = hasItem(wood);
    ...
    ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, wood, 4).requires(wood.getLogItemTag())
                          ...
                          .save(FinishedRecipe.output(consumer), location(folder + "planks"));
    // slab
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, slab, 6)
                       ...
                       .group("wooden_slab")
                       .save(FinishedRecipe.output(consumer), location(folder + "slab"));
    // stairs
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, stairs, 4)
                       ...
                       .unlockedBy("has_planks", hasPlanks)
                       .group("wooden_stairs")
                       .save(FinishedRecipe.output(consumer), location(folder + "stairs"));
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, wood.getWood(), 3)
                       ...
                       .save(FinishedRecipe.output(consumer), location(folder + "log_to_wood"));
    ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, wood.getStrippedWood(), 3)
                       ...
                       .save(FinishedRecipe.output(consumer), location(folder + "stripped_log_to_wood"));
    // doors
    ...
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, wood.getSign(), 3)
                       ...
                       .unlockedBy("has_planks", hasItem(wood))
                       .save(FinishedRecipe.output(consumer), location(folder + "sign"));
    ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, wood.getHangingSign(), 6)
                       ...
                       .save(FinishedRecipe.output(consumer), location(folder + "hanging_sign"));
  }

  abstract class RecipeProviderAccess extends RecipeProvider {
    private RecipeProviderAccess() {
      super(null, null);
    }

    static Criterion<?> hasItem(ItemLike item) {
      return RecipeProvider.has(item);
    }

    static Criterion<?> hasItem(TagKey<Item> tag) {
