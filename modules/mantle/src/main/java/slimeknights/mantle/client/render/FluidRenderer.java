...
public class FluidRenderer {
  ...
  public static void putTexturedQuad(VertexConsumer renderer, Matrix4f matrix, TextureAtlasSprite sprite, Vector3f from, Vector3f to, Direction face, int color, int brightness, int rotation, boolean flowing) {
    ...
    switch (face) {
      case DOWN -> {
        addVertex(renderer, matrix, x1, y1, z2, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x1, y1, z1, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x2, y1, z1, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x2, y1, z2, r, g, b, a, u4, v4, light1, light2);
      }
      case UP -> {
        addVertex(renderer, matrix, x1, y2, z1, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x1, y2, z2, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x2, y2, z2, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x2, y2, z1, r, g, b, a, u4, v4, light1, light2);
      }
      case NORTH -> {
        addVertex(renderer, matrix, x1, y1, z1, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x1, y2, z1, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x2, y2, z1, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x2, y1, z1, r, g, b, a, u4, v4, light1, light2);
      }
      case SOUTH -> {
        addVertex(renderer, matrix, x2, y1, z2, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x2, y2, z2, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x1, y2, z2, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x1, y1, z2, r, g, b, a, u4, v4, light1, light2);
      }
      case WEST -> {
        addVertex(renderer, matrix, x1, y1, z2, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x1, y2, z2, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x1, y2, z1, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x1, y1, z1, r, g, b, a, u4, v4, light1, light2);
      }
      case EAST -> {
        addVertex(renderer, matrix, x2, y1, z1, r, g, b, a, u1, v1, light1, light2);
        addVertex(renderer, matrix, x2, y2, z1, r, g, b, a, u2, v2, light1, light2);
        addVertex(renderer, matrix, x2, y2, z2, r, g, b, a, u3, v3, light1, light2);
        addVertex(renderer, matrix, x2, y1, z2, r, g, b, a, u4, v4, light1, light2);
      }
    }
  ...
  private static void addVertex(VertexConsumer renderer, Matrix4f matrix, float x, float y, float z, int r, int g, int b, int a, float u, float v, int light1, int light2) {
