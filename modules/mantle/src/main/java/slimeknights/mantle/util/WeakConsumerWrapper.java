...
import slimeknights.mantle.util.compat.NonNullConsumer;

import java.lang.ref.WeakReference;

/**
 * Implementation of {@link NonNullConsumer} that weakly references a parent object.
 * Designed for use in {@link slimeknights.mantle.util.compat.LazyOptional#addListener(NonNullConsumer)},
