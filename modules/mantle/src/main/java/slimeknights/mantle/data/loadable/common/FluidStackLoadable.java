...
public class FluidStackLoadable {
  ...
  private static final Predicate<FluidStack> COMPACT_NBT = stack -> true;
  ...
  private static final LoadableField<CompoundTag,FluidStack> NBT = NBTLoadable.ALLOW_STRING.nullableField("nbt", stack -> null);
