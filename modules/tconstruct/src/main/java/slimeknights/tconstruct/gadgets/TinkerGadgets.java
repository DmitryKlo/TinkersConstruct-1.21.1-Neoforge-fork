...
public final class TinkerGadgets extends TinkerModule {
  ...
  void registerCapabilities(RegisterCapabilitiesEvent event) {
    PiggybackCapability.registerCapabilities(event);
  }
  ...
  void gatherData(final GatherDataEvent event) {
    ...
    generator.addProvider(event.includeServer(), new NamedDataProvider("TConstruct gadget recipes", new GadgetRecipeProvider(generator.getPackOutput(), event.getLookupProvider())));
  }
