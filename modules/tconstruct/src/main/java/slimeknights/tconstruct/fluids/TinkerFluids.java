...
public final class TinkerFluids extends TinkerModule {
  ...
  public static final FlowingFluidObject<SlimeFluid> earthSlime = FLUIDS.registerSlime("earth_slime").type(slime("earth_slime").temperature(350)).bucket().block(createEffect(MapColor.GRASS, 0, () -> new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(TinkerEffects.bouncy.get()), 5*20))).commonTag("slime").flowing(SlimeFluid.Source::new, SlimeFluid.Flowing::new);
  public static final FlowingFluidObject<SlimeFluid> skySlime   = FLUIDS.registerSlime("sky_slime"  ).type(slime("sky_slime"  ).temperature(310)).bucket().block(createEffect(MapColor.DIAMOND, 0, () -> new MobEffectInstance(BuiltInRegistries.MOB_EFFECT.wrapAsHolder(TinkerEffects.ricochet.get()), 5*20))).flowing(SlimeFluid.Source::new, SlimeFluid.Flowing::new);
  public static final FlowingFluidObject<SlimeFluid> enderSlime = FLUIDS.registerSlime("ender_slime").type(slime("ender_slime").temperature(370)).bucket().block(createEffect(MapColor.COLOR_PURPLE, 0, () -> new MobEffectInstance(TinkerEffects.holder(TinkerEffects.enderference), 5 * 20))).flowing(SlimeFluid.Source::new, SlimeFluid.Flowing::new);
  ...
  public static final FlowingFluidObject<BaseFlowingFluid> moltenEnder    = FLUIDS.registerStone("molten_ender").type(hot("molten_ender").temperature(777).lightLevel(5)).block(createEffect(MapColor.PLANT, 5, () -> new MobEffectInstance(TinkerEffects.holder(TinkerEffects.enderference), 5 * 20))).bucket().commonTag("ender").flowing();
  ...
  public static final EntityDataSerializer<FluidStack> FLUID_DATA_SERIALIZER = FluidDataSerializer.SERIALIZER;
  public static final RegistryObject<EntityDataSerializer<FluidStack>> FLUID_DATA_SERIALIZER_REGISTRY = DATA_SERIALIZERS.register("fluid", () -> FLUID_DATA_SERIALIZER);
