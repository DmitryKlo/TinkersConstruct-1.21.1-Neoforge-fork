...
public class MaterialTagProvider extends AbstractMaterialTagProvider {
  ...
  /** Adds material IDs to the tag */
  private static ResourceLocation[] mat(MaterialId... ids) {
    return Arrays.stream(ids).map(MaterialId::getLocation).toArray(ResourceLocation[]::new);
  }
  ...
  protected void addTags() {
    tag(TinkerTags.Materials.EXCLUDE_FROM_LOOT)
      ...
      .add(mat(MaterialIds.ancientHide))
    ...
    tag(TinkerTags.Materials.NETHER).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.NETHER_GATED).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.BASIC_AMMO).add(mat(
      // head
    ...
    tag(TinkerTags.Materials.BLAZING_BLOOD).add(mat(
    ...
    tag(TinkerTags.Materials.DISTANT).add(mat(
      // tiers 1-2
    ...
    )).addOptional(mat(MaterialIds.ironwood, MaterialIds.steeleaf, MaterialIds.fiery));

    // materials bartered by piglins
    tag(TinkerTags.Materials.BARTERED).add(mat(
      // tier 3
    ...
    tag(TinkerTags.Materials.COMPATABILITY_METALS).addOptional(mat(
      // tier 2
    ...
    tag(TinkerTags.Materials.COMPATABILITY_ALLOYS).addOptional(mat(MaterialIds.bronze, MaterialIds.constantan, MaterialIds.invar, MaterialIds.electrum, MaterialIds.pewter, MaterialIds.nicrosil));

    // material categories
    // melee harvest
    tag(TinkerTags.Materials.GENERAL).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.HARVEST).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.MELEE).add(mat(
      // tier 1
    ...
    // ranged
    tag(TinkerTags.Materials.BALANCED).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.LIGHT).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.HEAVY).add(mat(
      // tier 1
    ...
    tag(TinkerTags.Materials.SLIMESKULL).add(mat(
      // creeper
      MaterialIds.glass,
      // zombie
