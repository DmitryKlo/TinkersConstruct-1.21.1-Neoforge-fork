...
public class TinkerEffect extends MobEffect {
  ...
  /** @deprecated use {@link #addAttributeModifier(Holder, ResourceLocation, double, Operation)} */
  @Deprecated
  public TinkerEffect addAttributeModifier(Attribute attribute, String id, double amount, Operation operation) {
    return addAttributeModifier(BuiltInRegistries.ATTRIBUTE.wrapAsHolder(attribute), modifierId(id), amount, operation);
  }

  /** @deprecated use {@link #addAttributeModifier(Holder, ResourceLocation, double, Operation)} */
  @Deprecated
  public TinkerEffect addAttributeModifier(Holder<Attribute> attribute, String id, double amount, Operation operation) {
    return addAttributeModifier(attribute, modifierId(id), amount, operation);
  }

  private static ResourceLocation modifierId(String id) {
