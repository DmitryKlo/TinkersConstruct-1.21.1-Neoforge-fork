...
public class CastItemObject extends ItemObject<Item> {
  ...
  @Getter
  private final ResourceLocation sandId;
  @Getter
  private final ResourceLocation redSandId;
  ...
  public CastItemObject(ResourceLocation name, Item gold, Item sand, Item redSand) {
    ...
    this.name = name;
    this.sandId = BuiltInRegistries.ITEM.getKey(sand);
    this.redSandId = BuiltInRegistries.ITEM.getKey(redSand);
  ...
  public CastItemObject(ResourceLocation name, ItemObject<? extends Item> gold, ItemObject<? extends Item> sand, ItemObject<? extends Item> redSand) {
    super(gold);
    this.name = name;
    this.sandId = sand.getId();
    this.redSandId = redSand.getId();
    this.sand = sand;
