...
public class Config {
  ...
  public static class Common {
    ...
    Common(ModConfigSpec.Builder builder) {
      ...
      // Enchantments are data-driven in 1.21; slot extension needs datapack/event reimplementation
  ...
  public static class Client {
    //public final BooleanValue temperatureInCelsius;
    ...
    public final BooleanValue renderShieldSlotItem;
    public final BooleanValue renderSleevesItem;
    public final BooleanValue modifiersIDsInAdvancedTooltips;
    public final IntValue maxSmelteryItemQuads;
    ...
    // framed modifier
    public final BooleanValue renderItemFrame;
    public final IntValue itemFrameXOffset;
    public final IntValue itemFrameYOffset;
    public final EnumValue<Orientation2D> itemFrameLocation;
    public final IntValue itemsPerRow;

    // map modifier
    public final IntValue mapXOffset;
    public final IntValue mapYOffset;
    public final DoubleValue mapScale;
    public final EnumValue<Orientation2D> mapLocation;
