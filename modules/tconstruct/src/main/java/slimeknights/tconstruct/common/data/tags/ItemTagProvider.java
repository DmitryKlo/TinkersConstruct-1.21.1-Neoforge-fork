...
public class ItemTagProvider extends ItemTagsProvider {
  /** Twilight forest uncrafting table blacklist */
  ...
  /** Vanilla tag for mob head items */
  private static final TagKey<Item> MOB_HEADS = ItemTags.create(ResourceLocation.withDefaultNamespace("skulls"));
  ...
  private void addWorld() {
    IntrinsicTagAppender<Item> heads = this.tag(MOB_HEADS);
  ...
  private TagKey<Item> getArmorTag(ArmorItem.Type slotType) {
    return switch (slotType) {
      ...
      case HELMET -> HELMETS;
      case BODY -> ItemTags.create(ResourceLocation.withDefaultNamespace("body_armor"));
    };
  }
