...
public class ModifiableArrow extends AbstractArrow implements ToolProjectile, ReusableProjectile {
  ...
  public void setKnockback(int knockback) {
    // TODO 1.21: vanilla arrow knockback internals changed; restore additive knockback.
  }

  public void setPierceLevel(byte pierceLevel) {
    // TODO 1.21: setPierceLevel is private; restore additive piercing via components/enchant hooks.
  }
  ...
  public void addAdditionalSaveData(CompoundTag tag) {
    ...
    tag.put(KEY_STACK, this.stack.save(RegistryAccess.EMPTY, new CompoundTag()));
  ...
  public void readAdditionalSaveData(CompoundTag tag) {
    ...
    if (tag.contains(KEY_STACK, CompoundTag.TAG_COMPOUND)) {
      setStack(ItemStack.parseOptional(RegistryAccess.EMPTY, tag.getCompound(KEY_STACK)));
    }
