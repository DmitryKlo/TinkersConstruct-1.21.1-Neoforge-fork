...
public class TastyModifier extends Modifier implements ProcessLootModifierHook {
  ...
  protected void registerHooks(Builder hookBuilder) {
    ...
    hookBuilder.addModule(StatBoostModule.add(EdibleModule.HUNGER).eachLevel(1).build());
    hookBuilder.addModule(StatBoostModule.add(EdibleModule.SATURATION).flat(0.4f).build());
  }
