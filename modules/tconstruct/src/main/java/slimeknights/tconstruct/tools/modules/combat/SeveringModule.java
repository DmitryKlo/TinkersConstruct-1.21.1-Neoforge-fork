...
public enum SeveringModule implements ModifierModule, ProcessLootModifierHook {
  ...
  private static final net.minecraft.tags.TagKey<net.minecraft.world.item.Item> MOB_HEADS = ItemTags.create(ResourceLocation.withDefaultNamespace("skulls"));
  ...
  public void processLoot(IToolStackView tool, ModifierEntry modifier, List<ItemStack> generatedLoot, LootContext context) {
    ...
    if (entity != null) {
      ...
      if (generatedLoot.stream().noneMatch(stack -> stack.is(MOB_HEADS))) {
        // find proper recipe
