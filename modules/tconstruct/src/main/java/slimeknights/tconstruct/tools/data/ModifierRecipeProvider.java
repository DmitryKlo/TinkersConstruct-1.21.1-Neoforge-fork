...
public class ModifierRecipeProvider extends BaseRecipeProvider {
  ...
  private void addModifierRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    IncrementalModifierRecipeBuilder.modifier(ModifierIds.sharpness)
                                    .setTools(TinkerTags.Items.MELEE)
                                    .setInput(getItemTag("c", "storage_blocks/quartz"), 4, 36)
    ...
    SizedIngredient standardSkulls = SizedIngredient.of(DifferenceIngredient.of(Ingredient.of(getItemTag("c", "heads")), Ingredient.of(Items.DRAGON_HEAD)));
    ...
    ModifierRemovalRecipeBuilder.removal()
      .addInput(CompoundIngredient.of(
        FluidContainerIngredient.fromFluid(TinkerFluids.venom).asIngredient(),
        FluidContainerIngredient.fromIngredient(TinkerFluids.venom.ingredient(FluidValues.BOTTLE), Ingredient.of(TinkerFluids.venomBottle)).asIngredient())
      )
      .modifierPredicate(removable)
