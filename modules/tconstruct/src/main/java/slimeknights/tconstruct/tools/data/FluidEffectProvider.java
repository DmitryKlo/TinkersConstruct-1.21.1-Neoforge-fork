...
public class FluidEffectProvider extends AbstractFluidEffectProvider {
  ...
  protected void addFluids() {
    ...
    // ender - teleporting
    LivingEntityPredicate hasReturning = new HasMobEffectPredicate(Holder.direct(TinkerEffects.returning.get()));
    ...
    addMetal(TinkerFluids.moltenManyullyn).fireDamage(4).addEffect(FluidMobEffect.builder().effect(TinkerEffects.holder(TinkerEffects.bleeding), 20 * 3, 1), TimeAction.SET);
    ...
    compatMetal(TinkerFluids.moltenEnderium).magicDamage(4).addEffect(FluidMobEffect.builder().effect(TinkerEffects.holder(TinkerEffects.enderference), 20 * 10, 1), TimeAction.SET);
    // mekanism compat
    ...
    compatMetal(TinkerFluids.moltenRefinedObsidian).spikeDamage(3).addEffect(FluidMobEffect.builder().effect(TinkerEffects.holder(TinkerEffects.bleeding), 20 * 2, 1), TimeAction.SET);
