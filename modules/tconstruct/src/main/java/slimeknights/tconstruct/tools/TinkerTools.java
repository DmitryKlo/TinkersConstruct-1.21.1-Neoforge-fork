...
public final class TinkerTools extends TinkerModule {
  ...
  public static final RegistryObject<LootItemFunctionType<AddToolDataFunction>> lootAddToolData =
    LOOT_FUNCTIONS.register("add_tool_data", () -> new LootItemFunctionType<>(AddToolDataFunction.CODEC));
  ...
  // armor
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> travelersGear = ITEMS.registerEnum("travelers", ModifiableArmorMaterial.HUMANOID_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.TRAVELERS, type, UNSTACKABLE_PROPS));
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> plateArmor = ITEMS.registerEnum("plate", ModifiableArmorMaterial.HUMANOID_TYPES, type -> new MultilayerArmorItem(ArmorDefinitions.PLATE, type, UNSTACKABLE_PROPS));
  public static final EnumObject<ArmorItem.Type,ModifiableArmorItem> slimesuit = new EnumObject.Builder<ArmorItem.Type,ModifiableArmorItem>(ArmorItem.Type.class)
    ...
    .build();
  public static final ItemObject<MultilayerArmorItem> slimeWings = ITEMS.register("slime_wings", () -> new MultilayerArmorItem(ArmorDefinitions.SLIMESUIT.getHolder(), ArmorItem.Type.CHESTPLATE, UNSTACKABLE_PROPS, ArmorDefinitions.SLIME_WINGS, TinkerTools.slimeWings.getId()));
  ...
  void registerCapabilities(RegisterCapabilitiesEvent event) {
    ...
    if (FMLEnvironment.dist == Dist.CLIENT) {
      EquipmentChangeWatcher.registerCapabilities(event);
    }
  }
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      ToolStackItemPredicate.register();
  ...
  void gatherData(final GatherDataEvent event) {
    // TODO 1.21: restore tools datagen providers after RecipeOutput/tag/model ports.
  }
  ...
  private static void acceptEFLN(IModifiable item, CreativeModeTab.Output tab) {
    ...
    if (ToolMaterialHook.stats(definition).size() == 2) {
      ...
      if (gunpowder != IMaterial.UNKNOWN && prismarine != IMaterial.UNKNOWN) {
        ...
        stack.set(DataComponents.CUSTOM_NAME, Component.translatable(TConstruct.makeTranslationKey("item", "efln_ball")));
        tab.accept(stack);
      }
    }
  }
