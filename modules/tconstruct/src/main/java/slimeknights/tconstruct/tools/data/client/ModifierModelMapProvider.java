...
public class ModifierModelMapProvider extends AbstractModifierModelMapProvider {
  ...
  protected void addModels() {
    ...
    tool(TinkerTools.pickaxe).basic(SMALL,
      ...
      ModifierIds.experienced, ModifierIds.luck, TinkerModifiers.severing.getModifierId(), ModifierIds.silky,
    ...
    tool(TinkerTools.sledgeHammer).basic('/',
        ...
        ModifierIds.knockback,
        ModifierIds.blasting, ModifierIds.hydraulic
      ).basic(SMALL, ModifierIds.soulbound, TinkerModifiers.severing.getModifierId(), ModifierIds.necrotic)
    ...
    // plate armor
    ModifierId dyed = TinkerModifiers.dyed.getModifierId();
    ...
    tool("slime/wings").modifier(TinkerModifiers.trim.getModifierId(), new TrimModifierModel.Custom(toolMaterial("armor/slime/wings/trim").texture(), null));
