...
public abstract class TinyMultiblockControllerBlock extends ControllerBlock {
  ...
  public InteractionResult use(BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
    ...
    return openGui(player, world, pos) ? InteractionResult.SUCCESS : InteractionResult.PASS;
  }
  ...
  protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
    ...
    return openGui(player, world, pos) ? ItemInteractionResult.sidedSuccess(world.isClientSide) : ItemInteractionResult.PASS_TO_DEFAULT_BLOCK_INTERACTION;
  }
