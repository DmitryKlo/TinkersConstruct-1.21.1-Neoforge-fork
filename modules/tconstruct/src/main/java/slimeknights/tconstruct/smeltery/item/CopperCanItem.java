...
public class CopperCanItem extends Item {
  ...
  public static IFluidHandlerItem createFluidHandler(ItemStack stack, Void context) {
  ...
  public static Fluid getFluid(ItemStack stack) {
    ...
    if (nbt != null && nbt.contains(TAG_FLUID, Tag.TAG_STRING)) {
      ...
      if (location != null) {
        return BuiltInRegistries.FLUID.getOptional(location).orElse(Fluids.EMPTY);
      }
    }
    return Fluids.EMPTY;
  }
