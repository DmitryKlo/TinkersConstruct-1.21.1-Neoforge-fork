...
public interface IToolRecipeHelper extends ICastCreationHelper {
   ...
   * @param tool       Tool
   * @param folder     Folder for recipe
   * @param layoutSlot Part builder pattern
   */
  default void toolBuilding(Consumer<FinishedRecipe> consumer, IModifiable tool, String folder, Pattern layoutSlot) {
    toolBuilding(consumer, tool, folder, layoutSlot.getLocation());
  }
