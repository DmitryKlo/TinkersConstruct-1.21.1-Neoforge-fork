...
public class AddToolDataFunction extends LootItemConditionalFunction {
  ...
  public static final MapCodec<AddToolDataFunction> CODEC = MapCodec.unit(() -> new AddToolDataFunction(List.of(), 0f, List.of()));
  ...
  public static class Serializer implements slimeknights.mantle.loot.legacy.LegacyLootSerializer<AddToolDataFunction> {
    ...
    @Override
    public AddToolDataFunction deserialize(JsonObject object, JsonDeserializationContext context) {
      ...
      return new AddToolDataFunction(List.of(), damage, materials);
    }
  }
  ...
  public static class Builder extends LootItemConditionalFunction.Builder<AddToolDataFunction.Builder> {
    private final com.google.common.collect.ImmutableList.Builder<RandomMaterial> materials = com.google.common.collect.ImmutableList.builder();
    ...
    @Override
    public AddToolDataFunction build() {
