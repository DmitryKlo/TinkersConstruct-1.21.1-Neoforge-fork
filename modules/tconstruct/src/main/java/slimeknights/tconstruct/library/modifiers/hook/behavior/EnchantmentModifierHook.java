...
public interface EnchantmentModifierHook {
  ...
  static Map<Enchantment,Integer> getAllEnchantments(ItemStack stack) {
    ItemEnchantments stackEnchantments = stack.getEnchantments();
    Map<Enchantment,Integer> enchantments = new HashMap<>(stackEnchantments.entrySet().size());
    for (var entry : stackEnchantments.entrySet()) {
