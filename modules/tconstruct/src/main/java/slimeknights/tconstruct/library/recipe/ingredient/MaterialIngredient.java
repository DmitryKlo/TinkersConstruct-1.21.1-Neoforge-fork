...
public class MaterialIngredient extends NestedIngredient {
  ...
  public static Ingredient of(Ingredient ingredient, IJsonPredicate<MaterialVariantId> material) {
    return new MaterialIngredient(ingredient, material).asIngredient();
  }
  ...
  public static Ingredient of(Ingredient ingredient) {
    return new MaterialIngredient(ingredient, MaterialPredicate.ANY).asIngredient();
  }
  ...
  public JsonElement toJson() {
    JsonElement parent = serializeNested(nested);
    JsonObject result;
    if (isVanilla(nested) && parent.isJsonObject()) {
  ...
  public enum Serializer implements IIngredientSerializer<MaterialIngredient> {
    ...
    public MaterialIngredient parse(JsonObject json) {
      ...
      if (json.has("match")) {
        ...
        ingredient = VanillaIngredientSerializer.INSTANCE.parse(nested);
      }
    ...
    public MaterialIngredient parse(FriendlyByteBuf buffer) {
      return new MaterialIngredient(
        Ingredient.CONTENTS_STREAM_CODEC.decode((net.minecraft.network.RegistryFriendlyByteBuf) buffer),
