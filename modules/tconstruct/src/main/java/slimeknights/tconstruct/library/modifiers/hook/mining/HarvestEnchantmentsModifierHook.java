...
public interface HarvestEnchantmentsModifierHook {
  ...
  static ItemEnchantments updateHarvestEnchantments(IToolStackView tool, ItemStack stack, ToolHarvestContext context) {
    ...
    if (player == null || !player.isCreative()) {
      ...
      Map<Enchantment,Holder<Enchantment>> holders = null;
          ...
          for (ModifierEntry entry : armor.getModifierList()) {
            ...
            if (hook != null) {
              ...
              if (enchantments == null) {
                ...
                enchantments = new HashMap<>(originalEnchants.entrySet().size());
                holders = new HashMap<>(originalEnchants.entrySet().size());
                for (var enchantmentEntry : originalEnchants.entrySet()) {
                  Enchantment enchantment = enchantmentEntry.getKey().value();
                  enchantments.put(enchantment, enchantmentEntry.getIntValue());
                  holders.put(enchantment, enchantmentEntry.getKey());
                }
              }
      ...
      if (enchantments != null) {
        ...
        for (Map.Entry<Enchantment,Integer> entry : enchantments.entrySet()) {
          Holder<Enchantment> holder = holders.get(entry.getKey());
          if (holder != null) {
