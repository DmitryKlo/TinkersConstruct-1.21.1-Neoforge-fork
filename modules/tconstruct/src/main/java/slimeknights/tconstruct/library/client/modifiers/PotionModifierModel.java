      ...
      if (toolData.contains(key, Tag.TAG_STRING)) {
        ...
        if (id != null) {
          ...
          if (potion != null && !potion.is(Potions.WATER)) {
            quadConsumer.accept(MantleItemLayerModel.getQuadsForSprite(0xFF000000 | PotionHelper.getColor(PotionHelper.setPotion(new ItemStack(Items.POTION), potion)), -1, spriteGetter.apply(texture), transforms, 0, pixels));
          }
        }
      }
    }
