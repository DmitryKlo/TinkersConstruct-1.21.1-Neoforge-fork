...
public class ToolBuildingRecipeBuilder extends AbstractRecipeBuilder<ToolBuildingRecipeBuilder> {
  ...
  /** Adds an extra custom ingredient requirement */
  public ToolBuildingRecipeBuilder addExtraRequirement(AbstractIngredient ingredient) {
    return addExtraRequirement(ingredient.asIngredient());
  }

  /** Sets the layout slot directly. */
  public ToolBuildingRecipeBuilder layoutSlot(ResourceLocation layoutSlot) {
    this.layoutSlot = layoutSlot;
    return this;
  }

  /** Sets the layout slot from a part builder pattern. */
  public ToolBuildingRecipeBuilder layoutSlot(Pattern pattern) {
    this.layoutSlot = pattern.getLocation();
    return this;
  }
