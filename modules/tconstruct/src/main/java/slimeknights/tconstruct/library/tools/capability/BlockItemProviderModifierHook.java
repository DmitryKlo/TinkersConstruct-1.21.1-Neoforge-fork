...
public interface BlockItemProviderModifierHook {
    ...
    record CapabilityImpl(IToolStackView tool) implements BlockItemProviderCapability {
        ...
        public void consume(ItemStack capStack, ItemStack backingStack, @Nullable LivingEntity entity) {
            ...
            TConstruct.LOG.warn("Could not find a modifier to consume {} from after providing it from ToolBlockItemProviderHook. This is likely causing a duplication glitch! Stack: {}", BuiltInRegistries.ITEM.getKey(backingStack.getItem()), backingStack);
        }
    }
    ...
    class Provider implements ToolCapabilityProvider.IToolCapabilityProvider {
        ...
        private BlockItemProviderCapability lazy;
        ...
        @Override
        public BlockItemProviderCapability getBlockItemProvider(IToolStackView toolView) {
            if (lazy == null) {
                lazy = new CapabilityImpl(tool.get());
            }
            return lazy;
        }
    }
