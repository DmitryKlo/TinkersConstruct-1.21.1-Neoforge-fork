...
public abstract class AbstractMaterialSpriteProvider {
  private static final MaterialStatsId SLIMESUIT = new MaterialStatsId(TConstruct.MOD_ID, "slimesuit");
  private static final MaterialStatsId ARMOR_PLATING = new MaterialStatsId(TConstruct.MOD_ID, "armor_plating");
  private static final MaterialStatsId ARMOR_MAILLE = new MaterialStatsId(TConstruct.MOD_ID, "armor_maille");
  private static final MaterialStatsId ARMOR_CUIRASS = new MaterialStatsId(TConstruct.MOD_ID, "armor_cuirass");
  ...
  protected static class MaterialSpriteInfoBuilder {
    ...
    public MaterialSpriteInfoBuilder slime() {
      return statType(SlimeStats.ID, SLIMESUIT).repairKit();
    }
