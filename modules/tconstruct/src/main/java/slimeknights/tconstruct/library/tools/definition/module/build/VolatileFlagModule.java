...
public final class VolatileFlagModule implements VolatileDataToolHook, ToolModule {
  private static final List<ModuleHook<?>> DEFAULT_HOOKS = HookProvider.<VolatileFlagModule>defaultHooks(ToolHooks.VOLATILE_DATA);
  public static final RecordLoadable<VolatileFlagModule> LOADER = RecordLoadable.create(
    Loadables.RESOURCE_LOCATION.requiredField("flag", VolatileFlagModule::flag),
    VolatileFlagModule::new);

  private final ResourceLocation flag;

  public ResourceLocation flag() {
    return flag;
  }
