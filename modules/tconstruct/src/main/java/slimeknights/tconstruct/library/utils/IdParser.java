...
public record IdParser<T extends ResourceId>(Function<String, T> constructor, String name) implements StringLoadable<T> {
  ...
  /** Splits the given string into a namespace and path */
  public static String[] decompose(String location, char separator) {
    return decompose("minecraft", location, separator);
  }
