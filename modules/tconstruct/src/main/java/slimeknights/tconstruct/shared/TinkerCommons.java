...
public final class TinkerCommons extends TinkerModule {
  ...
  public static final ItemObject<TintedGlassBlock> clearTintedGlass = BLOCKS.register("clear_tinted_glass", () -> new TintedGlassBlock(glassBuilder(MapColor.COLOR_GRAY).noOcclusion().isRedstoneConductor((state, getter, pos) -> false).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)), BLOCK_ITEM);
  ...
  /* Loot conditions */
  public static final RegistryObject<LootItemConditionType> lootConfig = LOOT_CONDITIONS.register(ConfigEnabledCondition.ID.getPath(), () -> new LootItemConditionType(com.mojang.serialization.MapCodec.unit(ConfigEnabledCondition.SPAWN_WITH_BOOK)));
  public static final RegistryObject<LootItemConditionType> lootBlockOrEntity = LOOT_CONDITIONS.register("block_or_entity", () -> new LootItemConditionType(com.mojang.serialization.MapCodec.unit(BlockOrEntityCondition.INSTANCE)));
  public static final RegistryObject<LootItemConditionType> hasLootContextSet = LOOT_CONDITIONS.register("has_context_set", () -> new LootItemConditionType(com.mojang.serialization.MapCodec.unit(new HasLootContextSetCondition(net.minecraft.world.level.storage.loot.parameters.LootContextParamSets.EMPTY))));
  /** @deprecated use {@link slimeknights.mantle.loot.MantleLoot#TAG_FILLED} */
  @SuppressWarnings("removal")
  @Deprecated(forRemoval = true)
  public static final RegistryObject<LootItemConditionType> lootTagNotEmptyCondition = LOOT_CONDITIONS.register("tag_not_empty", () -> new LootItemConditionType(com.mojang.serialization.MapCodec.unit(new TagNotEmptyCondition<>(net.minecraft.tags.ItemTags.PLANKS))));
  ...
  void registerRecipeSerializers(RegisterEvent event) {
    if (event.getRegistryKey() == Registries.RECIPE_SERIALIZER) {
      ...
      CriteriaTriggers.register(TConstruct.getResource("container_opened").toString(), CONTAINER_OPENED_TRIGGER);
  ...
  void gatherData(final GatherDataEvent event) {
    ...
    // TODO 1.21: restore sprite source provider after ShieldBannerModifierSpriteSource is ported.
