...
public class TinkerEffects extends TinkerModule {
  ...
  private static void brewing(EnumObject<PotionType,Potion> potion, net.minecraft.core.Holder<Potion> base, Ingredient ingredient) {
    // TODO 1.21: re-register potion brewing through the new PotionBrewing bootstrap/builder path.
  }
